...
class ClientValidator_Zend_Validate_EmailAddress extends ClientValidator_Abstract
{
	/**
	...
	{
		$formRules->rules->$elementName->email = true;
		$formRules->messages->$elementName->email = 'Veuillez taper une adresse valide';
